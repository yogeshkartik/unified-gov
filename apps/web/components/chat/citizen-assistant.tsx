...
export function CitizenAssistant() {
  ...
  return <>
    ...
    {open ? <Dialog isOpen={open} onOpenChange={setOpen} showCloseButton={false} className="h-[calc(100dvh-1rem)] w-[calc(100vw-1rem)] max-w-[1200px] gap-0 overflow-hidden rounded-xl p-0 shadow-2xl sm:h-[88vh] sm:w-[85vw] [&_[data-slot=dialog]]:grid [&_[data-slot=dialog]]:grid-rows-[auto_1fr] [&_[data-slot=dialog]]:gap-0" overlayClassName="z-50 bg-black/45 backdrop-blur-sm">
