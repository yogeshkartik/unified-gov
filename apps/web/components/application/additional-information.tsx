...
export function AdditionalInformation({ applicationId }: { applicationId: string }) {
  ...
  async function save(values: DynamicFormValues) {
    ...
    try {
      ...
      setSubmitError("We could not save your information. Check your entries and try again.");
      setSubmitting(false);
    }
  }
