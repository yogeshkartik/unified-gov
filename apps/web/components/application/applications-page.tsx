...
export function ApplicationsPage() {
  ...
  async function deleteDraft(application: CitizenApplicationSummary) {
    if (!window.confirm(`Delete the draft for ${application.service_name}? This cannot be undone.`)) return;
