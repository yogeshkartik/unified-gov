...
import { applicationUi, chatbotUi, deadlineUi, jurisdictionUi, phase2ChatbotUi, phase3ChatbotUi, phase4ChatbotUi, phase5ChatbotUi, regionalDictionaries, statusUi } from "@/src/i18n/regional";

export type { Language } from "@/src/i18n/languages";
type TextSize = "small" | "default" | "large";
export type TranslationKey = keyof typeof en | keyof typeof chatbotUi.en | keyof typeof phase2ChatbotUi.en | keyof typeof phase3ChatbotUi.en | keyof typeof phase4ChatbotUi.en | keyof typeof phase5ChatbotUi.en;
type TranslationValues = Record<string, string | number>;
const dictionaries: Partial<Record<Language, Partial<Record<TranslationKey, string>>>> = { en: { ...en, ...chatbotUi.en, ...phase2ChatbotUi.en, ...phase3ChatbotUi.en, ...phase4ChatbotUi.en, ...phase5ChatbotUi.en }, hi: { ...hi, ...chatbotUi.hi, ...phase2ChatbotUi.hi, ...phase3ChatbotUi.hi, ...phase4ChatbotUi.hi, ...phase5ChatbotUi.hi, ...deadlineUi.hi }, mr: { ...mr, ...chatbotUi.mr, ...phase2ChatbotUi.mr, ...phase3ChatbotUi.mr, ...phase4ChatbotUi.mr, ...phase5ChatbotUi.mr, ...deadlineUi.mr }, kn: { ...regionalDictionaries.kn, ...applicationUi.kn, ...chatbotUi.kn, ...phase2ChatbotUi.kn, ...phase3ChatbotUi.kn, ...phase4ChatbotUi.kn, ...phase5ChatbotUi.kn, ...deadlineUi.kn, ...statusUi.kn, ...jurisdictionUi.kn }, ta: { ...regionalDictionaries.ta, ...applicationUi.ta, ...chatbotUi.ta, ...phase2ChatbotUi.ta, ...phase3ChatbotUi.ta, ...phase4ChatbotUi.ta, ...phase5ChatbotUi.ta, ...deadlineUi.ta, ...statusUi.ta, ...jurisdictionUi.ta }, te: { ...regionalDictionaries.te, ...applicationUi.te, ...chatbotUi.te, ...phase2ChatbotUi.te, ...phase3ChatbotUi.te, ...phase4ChatbotUi.te, ...phase5ChatbotUi.te, ...deadlineUi.te, ...statusUi.te, ...jurisdictionUi.te }, bn: { ...regionalDictionaries.bn, ...applicationUi.bn, ...chatbotUi.bn, ...phase2ChatbotUi.bn, ...phase3ChatbotUi.bn, ...phase4ChatbotUi.bn, ...phase5ChatbotUi.bn, ...deadlineUi.bn, ...statusUi.bn, ...jurisdictionUi.bn } };
