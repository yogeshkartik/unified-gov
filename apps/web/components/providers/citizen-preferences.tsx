...
const dictionaries: Partial<Record<Language, Partial<Record<TranslationKey, string>>>> = { en, hi, mr, kn: { ...regionalDictionaries.kn, ...applicationUi.kn, ...statusUi.kn }, ta: { ...regionalDictionaries.ta, ...applicationUi.ta, ...statusUi.ta }, te: { ...regionalDictionaries.te, ...applicationUi.te, ...statusUi.te }, bn: { ...regionalDictionaries.bn, ...applicationUi.bn, ...statusUi.bn } };
